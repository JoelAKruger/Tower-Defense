...
REM clang -g -O3 -Wno-writable-strings src/Game.cpp -o build/TowerDefense.exe

REM clang -g -DDEBUG -DDEVELOPER_MODE=1 -Wno-writable-strings -shared src/Engine/DllMain.cpp -o build/Engine.dll
